...
RoomDetail.propTypes = {
  ...
  rockSelectedP1: PropTypes.string.isRequired,
  rockSelectedP2: PropTypes.string.isRequired,
  paperSelectedP1: PropTypes.string.isRequired,
  paperSelectedP2: PropTypes.string.isRequired,
  scissorsSelectedP1: PropTypes.string.isRequired,
  scissorsSelectedP2: PropTypes.string.isRequired,

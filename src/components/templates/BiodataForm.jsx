    ...
    <div className='biodata'>
      ...
      <form className='biodata-form' onSubmit={handleSubmit}>
        ...
        <div className='bio-fullname'>
          <InputForm name='firstname' type='text' placeholder='First name' label='Fullname' handleChange={handleChange} value={values.firstname ? values.firstname : ''} pattern='.{0,20}$' errorMessage='Firstname max 20 chars' />
          <InputForm name='lastname' type='text' placeholder='Last name' label='.' styleLabel={{ color: 'transparent' }} handleChange={handleChange} value={values.lastname ? values.lastname : ''} pattern='.{0,10}$' errorMessage='Lastname max 10 chars' />
        </div>
        <InputForm type='text' name='address' label='Address' placeholder='Unitary State of the Republic of Isekai' handleChange={handleChange} value={values.address ? values.address : ''} pattern='.{0,43}$' errorMessage='Address max 43 chars' />
        <div className='other-bio'>
          <InputForm type='date' name='date' label='Date of Birth' handleChange={handleChange} value={values.date ? values.date : ''} />
